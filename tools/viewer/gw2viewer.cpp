...
static MaterialGPU load_material(const castlemist::model::Material &mat, const std::string &dat)
{
    MaterialGPU g;
...
static void build_mesh(const castlemist::model::Model &model, const std::string &dat)
{
...
int main(int argc, char **argv)
{
    ...
    castlemist::model::Model model = castlemist::model::Extractor(modl, tj).extract();
